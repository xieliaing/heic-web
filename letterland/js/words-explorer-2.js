...
(function () {
  var raw = [
    ...
    //  FEELINGS & CHARACTER
    // =====================================================================
    ["HAPPY", "😊", "feelings", "Feeling pleased and full of cheer.", "The good news made everyone ___."],
    ["NERVOUS", "😰", "feelings", "Worried and jumpy about something coming up.", "He felt ___ before his turn on stage."],
    ["EXCITED", "🤩", "feelings", "So eager about something that you can hardly keep still.", "She was too ___ to sleep."],
    ["LONELY", "😔", "feelings", "Sad because you are on your own.", "The new boy felt ___ at lunch."],
    ["JEALOUS", "😒", "feelings", "Unhappy because somebody else has what you want.", "He was ___ of his sister's new bike."],
    ["PROUD", "😌", "feelings", "Pleased with something good you or yours have done.", "Mum was ___ of my report."],
    ["CURIOUS", "🤔", "feelings", "Wanting very much to find something out.", "The noise made us ___."],
    ["GRATEFUL", "🙏", "feelings", "Thankful for something somebody did for you.", "We are ___ for all your help."],
    ["PATIENT", "⏳", "feelings", "Able to wait calmly without complaining.", "Please be ___, it is nearly ready."],
    ["GENEROUS", "🎁", "feelings", "Happy to share and give things away.", "It was ___ of her to share her lunch."],
    ["HONEST", "🤝", "feelings", "Always telling the truth.", "An ___ answer is better than a clever one."],
    ["BRAVE", "🦁", "feelings", "Willing to face something frightening.", "It was ___ of him to speak up."],
    ["GENTLE", "🕊️", "feelings", "Soft and careful, never rough.", "Be ___ with the kitten."],
    ["CHEERFUL", "😄", "feelings", "Bright and full of good spirits.", "She gave a ___ wave."],
    ["ANXIOUS", "😟", "feelings", "Uneasy and full of worry.", "He grew ___ as the storm came closer."],
    ["CONFIDENT", "💪", "feelings", "Sure that you can do the thing in front of you.", "She felt ___ about the test."],
    ["DISAPPOINTED", "😞", "feelings", "Let down because something did not turn out well.", "We were ___ when the trip was cancelled."],
    ["EMBARRASSED", "😳", "feelings", "Uncomfortable because people noticed a mistake.", "He was ___ when he tripped."],
    ["FURIOUS", "😡", "feelings", "Extremely angry.", "She was ___ about the broken window."],
    ["SURPRISED", "😲", "feelings", "Caught off guard by something you did not expect.", "We were ___ by the party."],
    ["CONFUSED", "😕", "feelings", "Unable to make sense of something.", "The map left us totally ___."],
    ["RELIEVED", "😮‍💨", "feelings", "Glad because a worry has finally lifted.", "I was ___ when the dog came home."],
    ["THOUGHTFUL", "💭", "feelings", "Careful about how other people feel.", "That was a ___ thing to do."],
    ["STUBBORN", "🐐", "feelings", "Refusing to change your mind.", "He is too ___ to admit it."],
    ["POLITE", "🙇", "feelings", "Showing good manners to others.", "A ___ answer costs nothing."],
    ["LOYAL", "🐕", "feelings", "Always sticking by your friends.", "A ___ friend never gossips."],
    ["CAREFUL", "🧐", "feelings", "Taking your time so nothing goes wrong.", "Be ___ on the icy path."],
    ["CLUMSY", "🤸", "feelings", "Always knocking things over.", "I am too ___ to carry the tray."],
    ["EAGER", "🏃", "feelings", "Keen and ready to start.", "The team was ___ to begin."],
    ["CALM", "🧘", "feelings", "Quiet and steady, not upset.", "Try to stay ___ and breathe."],

    // =====================================================================
    //  ACTIONS
    // =====================================================================
    ["GALLOP", "🐎", "actions", "To run the way a horse does at full speed.", "The pony began to ___ across the field."],
    ["WHISPER", "🤫", "actions", "To speak so softly that only one person hears.", "She had to ___ in the library."],
    ["SHOUT", "📢", "actions", "To call out very loudly.", "Do not ___ across the room."],
    ["STUMBLE", "🦶", "actions", "To trip and nearly fall.", "I ___ on the loose step every time."],
    ["SCRAMBLE", "🧗", "actions", "To climb using hands and feet in a hurry.", "We had to ___ up the bank."],
    ["WANDER", "🚶", "actions", "To walk about with no particular place to go.", "We let the path ___ where it liked."],
    ["SQUEEZE", "🤏", "actions", "To press something tightly together.", "___ the sponge over the bucket."],
    ["STRETCH", "🙆", "actions", "To reach out as far as you can.", "___ your arms above your head."],
    ["TREMBLE", "😨", "actions", "To shake slightly from cold or fear.", "His hands began to ___."],
    ["WRESTLE", "🤼", "actions", "To struggle and grapple with someone.", "The puppies ___ on the rug."],
    ["SCATTER", "🌾", "actions", "To throw or spread things in all directions.", "___ the seed across the bed."],
    ["GATHER", "🧺", "actions", "To bring things together into one place.", "___ the apples into the basket."],
    ["DISCOVER", "🔎", "actions", "To find something for the first time.", "We ___ a nest under the eaves."],
    ["EXPLORE", "🧭", "actions", "To travel through a place to learn what is there.", "Let's ___ the far side of the wood."],
    ["EXAMINE", "🔬", "actions", "To look at something very closely.", "The vet will ___ the puppy."],
    ["COMPARE", "⚖️", "actions", "To look at two things and see how they differ.", "___ the two drawings carefully."],
    ["DESCRIBE", "🗣️", "actions", "To say what something is like.", "Can you ___ what you saw?"],
    ["EXPLAIN", "💬", "actions", "To make something clear to somebody.", "Please ___ the rules again."],
    ["PROMISE", "🤞", "actions", "To say for certain that you will do something.", "I ___ to feed the cat."],
    ["PRETEND", "🎭", "actions", "To act as if something were true when it is not.", "Let's ___ the rug is a raft."],
    ["IMAGINE", "💭", "actions", "To make a picture of something in your mind.", "___ a world with no cars."],
    ["REMEMBER", "🧠", "actions", "To keep something in your mind and call it back.", "I cannot ___ where I left it."],
    ["FORGET", "🤦", "actions", "To lose something out of your memory.", "Do not ___ your lunch box."],
    ["DECIDE", "🤔", "actions", "To make up your mind between choices.", "We must ___ before Friday."],
    ["PRACTISE", "🎻", "actions", "To repeat something in order to improve.", "I ___ for twenty minutes a day."],
    ["FOLLOW", "👣", "actions", "To go along behind somebody or something.", "___ the yellow markers."],
    ["DELIVER", "📦", "actions", "To take something to the person expecting it.", "They ___ the parcel by noon."],
    ["REPAIR", "🔧", "actions", "To fix something that is broken.", "Dad will ___ the fence."],
    ["PROTECT", "🛡️", "actions", "To keep something safe from harm.", "Helmets ___ your head."],
    ["RESCUE", "🛟", "actions", "To save somebody from danger.", "They ___ the cat from the tree."],
    ["CELEBRATE", "🎉", "actions", "To do something special to mark a happy event.", "We ___ with a picnic."],
    ["ANNOUNCE", "📣", "actions", "To tell everybody some news.", "They will ___ the winner soon."],
    ["ARRIVE", "🚪", "actions", "To reach the place you were going.", "The bus should ___ at nine."],
    ["DEPART", "🚉", "actions", "To leave on a journey.", "The train will ___ from platform four."],
    ["SEARCH", "🔦", "actions", "To look hard for something lost.", "Let's ___ under the beds."],
    ["OBSERVE", "👁️", "actions", "To watch something carefully to learn about it.", "___ the moth without touching it."],
    ["STRUGGLE", "😣", "actions", "To try very hard against something difficult.", "We had to ___ through deep snow."],
    ["SWALLOW", "😋", "actions", "To make food go down your throat.", "Chew well before you ___."],
    ["SPRINT", "🏃", "actions", "To run flat out over a short distance.", "He had to ___ for the bus."],
    ["GLANCE", "👀", "actions", "To look at something very quickly.", "She stole a ___ at the clock."],

    // =====================================================================
    //  DESCRIBING WORDS
    // =====================================================================
    ["ENORMOUS", "🐋", "describing", "Far bigger than usual.", "An ___ wave broke over the rocks."],
    ["TINY", "🐜", "describing", "Extremely small.", "A ___ spider sat on the leaf."],
    ["NARROW", "🚪", "describing", "Not wide, with very little room across.", "The lane was too ___ for the van."],
    ["ELEGANT", "🦢", "describing", "Graceful and pleasing to look at.", "She drew an ___ curve."],
    ["MODERN", "🏢", "describing", "Belonging to the present time.", "The library is a ___ building."],
    ["SLIPPERY", "🧊", "describing", "So smooth or wet that things slide on it.", "The deck was ___ with rain."],
    ["FRAGILE", "🥚", "describing", "Easily broken and needing care.", "Mark the box ___."],
    ["STICKY", "🍯", "describing", "Clinging to whatever it touches.", "My hands were ___ with syrup."],
    ["ROUGH", "🪨", "describing", "Uneven and not smooth to touch.", "The bark felt ___ under my palm."],
    ["SMOOTH", "🪞", "describing", "Even all over, with no bumps.", "The pebble was ___ and cool."],
    ["TRANSPARENT", "🪟", "describing", "Clear enough to see straight through.", "The wings were almost ___."],
    ["INVISIBLE", "👻", "describing", "Impossible to see at all.", "Air is ___ but it is there."],
    ["DELICIOUS", "😋", "describing", "Tasting extremely good.", "The soup was ___."],
    ["DISGUSTING", "🤢", "describing", "So unpleasant it turns your stomach.", "The smell was ___."],
    ["MASSIVE", "🐘", "describing", "Very large and solid indeed.", "A ___ rock blocked the road."],
    ["FIERCE", "🐅", "describing", "Wild, strong and frightening.", "A ___ wind bent the trees."],
    ["TIMID", "🐁", "describing", "Easily frightened and shy.", "The ___ deer would not come near."],
    ["SILENT", "🤐", "describing", "Making no sound whatsoever.", "The house was completely ___."],
    ["NOISY", "🔊", "describing", "Full of loud sound.", "The classroom got very ___."],
    ["FILTHY", "🧽", "describing", "Extremely dirty.", "His boots were ___."],
    ["SPOTLESS", "✨", "describing", "Perfectly clean.", "The kitchen was ___."],
    ["HEAVY", "🏋️", "describing", "Weighing a very great deal.", "The crate was far too ___ to lift."],
    ["HOLLOW", "🪵", "describing", "Empty inside.", "The log was ___ and full of ants."],
    ["STURDY", "🪵", "describing", "Strongly built and unlikely to break.", "We need a ___ ladder."],
    ["FLEXIBLE", "🎋", "describing", "Able to bend without snapping.", "The young stem is ___."],
    ["STIFF", "📏", "describing", "Hard to bend at all.", "The new boots were ___."],
    ["PRECIOUS", "💎", "describing", "Worth a great deal, or deeply loved.", "That photo is ___ to her."],
    ["ORDINARY", "🙂", "describing", "Nothing special, just usual.", "It was an ___ Tuesday."],
    ["EXTRAORDINARY", "🌟", "describing", "Far beyond the usual.", "She has an ___ memory."],
    ["TALL", "🗼", "describing", "Reaching a very great height.", "The mast was impossibly ___."],
    ["SHALLOW", "🩱", "describing", "Not deep, only a little way down.", "Swim at the ___ end."],
    ["STEEP", "⛰️", "describing", "Rising or falling very sharply.", "The last part of the path is ___."],
    ["DISTANT", "🔭", "describing", "A very long way off.", "We heard a ___ rumble."],
    ["FREQUENT", "🔁", "describing", "Happening again and again.", "There are ___ buses on this road."],
    ["RARE", "🦤", "describing", "Hardly ever found.", "That bird is very ___ here."],
    ["WIDE", "🌊", "describing", "Measuring a great distance across.", "The river is ___ at the mouth."],
    ["BITTER", "☕", "describing", "Having a sharp unpleasant taste.", "The medicine was ___."],
    ["SPICY", "🌶️", "describing", "Full of hot flavour that stings the tongue.", "The curry was too ___ for me."],
    ["CRISPY", "🍟", "describing", "Firm and pleasantly crunchy.", "The chips came out ___."],
    ["GLOOMY", "🌫️", "describing", "Dark and rather miserable.", "It was a ___ afternoon."],
    ...
    ["SUBTRACT", "➖", "maths", "To take one number away from another.", "___ four from ten."],
    ["MULTIPLY", "✖️", "maths", "To add a number to itself a set number of times.", "___ six by seven."],
    ["DIVIDE", "➗", "maths", "To split a number into equal parts.", "___ the twelve cakes between four."],
    ...
    ["EQUAL", "🟰", "maths", "Exactly the same in size or amount.", "Cut it into four ___ pieces."],
    ...
    ["DOUBLE", "2️⃣", "maths", "Twice as much.", "___ the recipe for eight people."],
    ...
    ["CALCULATE", "🧮", "maths", "To work an answer out with numbers.", "___ the cost of five tickets."],
    ...
    ["EXPENSIVE", "💸", "money", "Costing a great deal.", "That bike is far too ___."],
    ["CHEAP", "🏷️", "money", "Costing very little.", "The market is ___ on Saturdays."],
    ...
    ["AFFORD", "💰", "money", "To have enough money for something.", "We cannot ___ it this month."],
    ["EXCHANGE", "🔄", "money", "To swap one thing for another.", "You can ___ it for a bigger size."],
    ...
    ["EARLY", "🐓", "time", "Before the expected time.", "We arrived ___ and waited."],
    ["IMMEDIATELY", "⚡", "time", "Right now, without any delay.", "Come inside ___."],
    ["GRADUALLY", "🐌", "time", "Slowly, a little at a time.", "The sky ___ cleared."],
    ["OCCASIONALLY", "🎲", "time", "Now and then, not often.", "We ___ walk to school."],
    ...
    ["RECYCLE", "♻️", "community", "To treat used things so they can be made into new ones.", "We ___ all our paper."],
    ...
    ["DOWNLOAD", "⬇️", "tech", "To copy something from the network onto your device.", "The ___ took ten minutes."],
    ...
    ["DIGITAL", "🔢", "tech", "Stored or shown as numbers rather than on paper.", "We keep a ___ copy."],
